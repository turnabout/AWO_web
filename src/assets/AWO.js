...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'F:/AWO_web/src/assets/AWO.data';
    var REMOTE_PACKAGE_BASE = 'AWO.data';
        ...
        DataRequest.prototype.byteArray = byteArray;
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_F:/AWO_web/src/assets/AWO.data');
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5265952,
    DYNAMIC_BASE = 5265952,
    DYNAMICTOP_PTR = 23040;
...
var _create_game = Module["_create_game"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_create_game"].apply(null, arguments)
};

var _create_game_entity_texture_reader = Module["_create_game_entity_texture_reader"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_create_game_entity_texture_reader"].apply(null, arguments)
};
...
var _free_game = Module["_free_game"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_free_game"].apply(null, arguments)
};

var _free_game_entity_visuals_reader = Module["_free_game_entity_visuals_reader"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_free_game_entity_visuals_reader"].apply(null, arguments)
};

var _get_next_game_tile_type = Module["_get_next_game_tile_type"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
...
var _prepare_design_room_game = Module["_prepare_design_room_game"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_prepare_design_room_game"].apply(null, arguments)
};

var _read_game_entity_texture = Module["_read_game_entity_texture"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_read_game_entity_texture"].apply(null, arguments)
};
...
var _run_game = Module["_run_game"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_run_game"].apply(null, arguments)
};
...
var _test_entity_visuals_reader = Module["_test_entity_visuals_reader"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_test_entity_visuals_reader"].apply(null, arguments)
};

var _unprepare_game = Module["_unprepare_game"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_unprepare_game"].apply(null, arguments)
};

var _update_game_editor_selected_entity = Module["_update_game_editor_selected_entity"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_update_game_editor_selected_entity"].apply(null, arguments)
};

var _update_game_window_dimensions = Module["_update_game_window_dimensions"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_update_game_window_dimensions"].apply(null, arguments)
};
